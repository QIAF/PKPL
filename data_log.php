...
<h3>Data Perubahan Kue Bolu</h3>
<hr>
<a href="input_cabang.php">Tambah Data</a>
<table border="1" cellspacing="0" width="100%">
    ...
    <?php
    include "koneksi.php";
    $sqlcabang = mysqli_query($konek, "SELECT * FROM log_data ORDER BY id_log ASC");

    while($d = mysqli_fetch_array($sqlcabang)){
        echo"<tr>
        <td align='center'>$d[id_log]</td>
        <td align='center'>$d[perubahan]</td>
